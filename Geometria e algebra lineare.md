...
- #TEOREMA(2). **Procedimento di ortonormalizzazione di Gram-Schmidt**
	...
	$\mathbf{u}_{2}=\frac{\left( \frac{1}{2},1,-\frac{1}{2} \right)}{\sqrt{\frac{1}{4}+1+\frac{1}{4}}}=\sqrt{\frac{2}{3}}\left( -\frac{1}{2},1,-\frac{1}{2} \right)=\left( -\frac{1}{6},\sqrt{\frac{2}{3}},-\frac{1}{\sqrt{6}} \right)$
