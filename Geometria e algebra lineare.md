...
- #TEOREMA(3). **Proiezione ed elemento di minima distanza**
	...
	*Dimostrazione*:
	...
	$\mathbf{w}\cdot\mathbf{e}_{j}=(\mathbf{v}-\mathbf{u})\cdot\mathbf{e}_{j}=\mathbf{v}\cdot\mathbf{e}_{j}-(\sum_{i=1}^n (\mathbf{v}\cdot\mathbf{e}_{i})e_{i})\cdot\mathbf{e}_{j}=\mathbf$