...
Le operazioni di somma di due vettori e di prodotto per uno scalare godono delle stesse proprietà formali che abbiamo evidenziato (precedentemente)[[#1.1 **Operazioni fondamentali sui vettori**]], come si verifica immediatamente in base alla definizione: